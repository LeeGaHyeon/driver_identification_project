...
class Cross_model(nn.Module):
    def __init__(self, num_frames=10, out_dim=11, valid_name='1'):
        ...
        #######################################
        self.eff = Efficient()
        self.eff.load_state_dict(torch.load(f'./weights/0801_fine_VI_w30_best_fold_{valid_name}.pth_best_loss.pth'))
        ...
        self.eff_MI.load_state_dict(torch.load(f'./weights/0802_fine_MI_w30_best_fold_{valid_name}.pth_best_loss.pth'))
