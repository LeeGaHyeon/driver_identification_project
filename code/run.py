...
Training list
python run.py --kernel-type 1109_fine_MI_w20 --out-dim 11 --data-folder  --enet-type Efficient --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 0 
python run.py --kernel-type 1109_fine_VI_w10 --out-dim 11 --data-folder images/ --enet-type Efficient --n-epochs 2 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 0

python run.py --kernel-type 1109_cross_w30 --out-dim 11 --data-folder images/ --enet-type Cross_model --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 0
python run.py --kernel-type 1109_self_VI --out-dim 11 --data-folder images/ --enet-type Self_VI --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 0
python run.py --kernel-type 1109_self_MI --out-dim 11 --data-folder images/ --enet-type Self_MI --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 0


python run.py --kernel-type 1109_VIVIT --out-dim 11 --data-folder images/ --enet-type VIVIT --n-epochs 2 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 0
python run.py --kernel-type 1109_cross_sensor_w10 --out-dim 11 --data-folder images/ --enet-type Cross_sensor --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 0
...
'''
최종 실행 코드
python run.py --kernel-type final_fine_VI_w30 --out-dim 15 --data-folder images/  --enet-type Efficient --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 0 
python run.py --kernel-type final_shuffle_fine_VI_w30 --out-dim 15 --data-folder images_shuffle/  --enet-type Efficient --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 2
'''
...
if __name__ == '__main__':
    ...
    visual = natsort.natsorted(glob.glob('./images_auto/visual_window10/***/**/*.jpg'))
    optical = natsort.natsorted(glob.glob('./images_auto/optical_window10/***/**/*.jpg'))
    n=10
    
    for j in range(len(count)):
        # train_loader, valid_loader_set, valid_name = fine_tuning_main('count', count[j], visual, n, mi=False) 
        # train_loader, valid_loader_set, valid_name = fine_tuning_main('count', count[j], optical, n, mi=True) 
...
#     visual = natsort.natsorted(glob.glob('./images_newjeans/visual_window20/*****/****/***/**/*.jpg'))
#     n=20
