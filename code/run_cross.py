...
Training list
python run_cross.py --kernel-type 0805_cross_w30 --out-dim 15 --data-folder images/ --enet-type Cross_model --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 0
'''
...
if __name__ == '__main__':
    ...
    visual = natsort.natsorted(glob.glob('./images_newjeans/visual_window30/*****/****/***/**/*.jpg'))
    optical = natsort.natsorted(glob.glob('./images_newjeans/optical_window30/*****/****/***/**/*.jpg'))
    n=30
