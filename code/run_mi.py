...
Training list
python run_mi_girae_tobi.py --kernel-type 0802_fine_MI_w30 --out-dim 15 --data-folder images/ --enet-type Efficient --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 1 
...
python run_mi.py --kernel-type final_fine_MI_w30 --out-dim 15 --data-folder images/ --enet-type Efficient --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 1 
python run_mi.py --kernel-type final_shuffle_fine_MI_w30 --out-dim 15 --data-folder images_shuffle/ --enet-type Efficient --n-epochs 100 --batch-size 8 --k-fold 0 --image-size 224 --CUDA_VISIBLE_DEVICES 3
'''
...
if __name__ == '__main__':
    ...
    optical = natsort.natsorted(glob.glob('./images_newjeans/optical_window20/*****/****/***/**/*.jpg'))
    n=20
